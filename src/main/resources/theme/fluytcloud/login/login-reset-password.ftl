...
<@layout.registrationLayout displayInfo=true; section>
    ...
    <#elseif section = "form">
        <form id="kc-reset-password-form" class="form reset-password ${properties.kcFormClass!}" action="${url.loginAction}" method="post">
            <h2 class="titulo-pagina">${msg("recuperarSenha")}</h2>
            ...
            <div class="${properties.kcFormGroupClass!}">
                <div id="kc-form-buttons" class="${properties.kcFormButtonsClass!}">
                    ...
                    <button class="mdc-button mdc-button--raised ${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonLargeClass!} custom-btn-action" type="submit">
                        ${msg("doSubmit")?no_esc}
                    </button>
                </div>
            </div>
