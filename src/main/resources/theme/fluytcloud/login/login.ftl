        ...
        <#if realm.password>
            <form id="kc-form-login" class="form ${properties.kcFormClass!}" action="${url.loginAction}" method="post">
                ...
                <div class="password-container ${properties.kcFormGroupClass!}">
                    ...
                    <div>
                        <div class="${properties.kcFormOptionsWrapperClass!} col-xs-12 esqueceu-senha-container">
                            <#if realm.resetPasswordAllowed>
                                <span><a href="${url.loginResetCredentialsUrl}" class="esqueceu-senha">${msg("doForgotPassword")}</a></span>
                            </#if>
                        </div>
                    </div>
